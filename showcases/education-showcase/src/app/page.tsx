    ...
    <main className="landing">
      <header className="landing-hero">
        ...
        <p className="landing-lede">
          One demonstration, three portals. A learner registers with a PID from a Wallet, receives a
          Student ID and a diploma as verifiable credentials, confirms payment with a payment
          credential, and applies for a job with selective disclosure. Enrolment, issuance and
          revocation are processed automatically by the National Learner Registry; every step lands
          in its audit trail. Revocation closes the loop.
        </p>
      </header>
      ...
      <section className="landing-section">
        ...
        <p className="guide-lede">
          Three organisations, one journey. Sessions persist per portal, so you can switch freely.
        </p>
      ...
      <section className="landing-section">
        ...
        <p className="guide-lede">
          ...
          its demo account, and the pulsing highlight on each screen marks the next thing to click.
        </p>
        ...
        <p className="landing-fineprint">
          Every person, institution and identifier in this showcase is fictional.
        </p>
      </section>
    </main>
  );
